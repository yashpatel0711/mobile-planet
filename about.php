                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    <p>
                                        Our mission is to offer the latest and most innovative mobile technology to our customers, ensuring seamless communication and enriching experiences. We strive to be more than just a marketplace; we aim to be your trusted partner in the world of smartphones.
                                    </p>
                                    <p>
                                        We strive to be more than just a marketplace; we aim to be your trusted partner in the world of smartphones.
                                    </p>
                                    <p>
                                        We believe in transparency, honesty, and ethical business practices.  Embracing change and staying ahead of the curve, we are driven by a passion for innovation that reflects in the products we offer.
                                    </p>
                                    <p>
                                        Your needs are at the heart of everything we do. We listen, learn, and adapt to ensure your experience with us exceeds expectations.
                                    </p>
                                    <p>
                                        Innovation!!
                                    </p>
                                    <p>
                                        The Mobile Planet with Phones Team
                                    </p>
                                </div>
                    		</div>
                    	</div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2023 Concept. All rights reserved. Dashboard by Mobile Planet Team.<a href="https://colorlib.com/wp/">Colorlib</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
